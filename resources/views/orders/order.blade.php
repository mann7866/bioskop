...
<div class="toast-container mt-5  position-fixed top-5 end-0 p-3" style="z-index: 11">
    <div class="toast mt-2 align-items-center text-bg-success border-0 show slide-down" role="alert" aria-live="assertive"
        aria-atomic="true">
        <div class="d-flex">
...
@endif
    ...
    @if (session('gagal'))
    <div class="toast-container mt-5 position-fixed top-5 end-0 p-3" style="z-index: 11">
        <div class="toast mt-2 align-items-center text-bg-danger border-0 show slide-down" role="alert" aria-live="assertive"
            aria-atomic="true">
            <div class="d-flex">
                <div class="toast-body">
                    {{ session('gagal') }}
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                @if ($item->status != 'paid' && $item->status != 'cancel')
                                    ...
                                    <form action="{{ route('paid', $item->id) }}" method="POST">
                                        @csrf
                                        @method('put')
