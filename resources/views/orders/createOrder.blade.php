                    ...
                    <form action="{{ route('order.store') }}" method="POST" id="orderForm">
                        ...
                        <div class="container">
                            ...
                            <div class="form-group">
                                <select class="form-control" id="studioSelect" name="id_studio"
                                    onchange="handleStudioChange(this)">
                                    <option value="">Pilih Studio</option>
                                    @foreach ($studio as $id_studio => $namaStudio)
                                        <option value="{{ $id_studio }}">{{ $namaStudio }}</option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h1 class="modal-title fs-5" id="exampleModalLabel">Pilih tempat Kursi:</h1>
                        ...
                        <script>
                                ...
                                if (studioId) {
                                    fetch(`/api/kursi/${studioId}`)
                                        ...
                                        .then(data => {
                                            ...
                                            data.kursi.forEach((nominal, index) => {
                                            ...
                                            document.getElementById('kursiCount').innerText = data.kursi.length;
                                        });
                                }
                            ...
                            document.addEventListener('DOMContentLoaded', function() {
                                ...
                                console.log(kursi); // Untuk memastikan data kursi benar-benar ada
