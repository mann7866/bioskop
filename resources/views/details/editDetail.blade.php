        ...
        <div class="col-12">
            ...
            <div class="col-md-6">
                ...
                <select class="mt-3 form-select @error('id_jamTayang') is-invalid @enderror"
                    ...
                    @foreach ($time as $item)
                        <option value="{{ $item->id }}" @if ($item->id == $detail->id_jamTayang) selected @endif>
                            {{ $item->jamTayang }}</option>
                    @endforeach
                </select>
                @error('id_jamTayang')
                    <div class="invalid-feedback">{{ $message }}</div>
            ...
            <div class="col-md-6">
                ...
                <select class="mt-3 form-select @error('id_tanggalTayang') is-invalid @enderror"
                    ...
                    @foreach ($time as $item)
                        <option value="{{ $item->id }}" @if ($item->id == $detail->id_tanggalTayang) selected @endif>
                            {{ $item->tanggalTayang }}</option>
                    @endforeach
                </select>
